...
const jellyfin_nfc = (nfc) => {
  console.log(
    'Control your jellyfin with NFC cards. Searching for PCSC-compatible NFC reader devices...'
  );
          ...
          for (const record of NDEFMessage) {
            ...
            switch (record.type) {
              ...
              case 'text':
                ...
                await process_jellyfin_command(received_text);
            }
          }
        } else {
          console.log(
